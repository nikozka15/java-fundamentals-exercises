...
public class CrazyStreams {
    ...
    public List<Account> findAccountsByBirthdayMonth(Month birthdayMonth) {
        return accounts.stream().filter(a -> a.getBirthday().getMonth() == birthdayMonth).toList();
    }
    ...
    public Map<Boolean, List<Account>> partitionMaleAccounts() {
        return accounts.stream().collect(Collectors.partitioningBy(a -> a.getSex().name().equals("MALE")));
    }
    ...
    public int getNumOfLettersInFirstAndLastNames() {
        return accounts.stream().mapToInt(a -> Math.addExact(a.getFirstName().length(), a.getLastName().length())).sum();
    }
    ...
    public List<Account> sortByFirstAndLastNames() {
        return accounts.stream()
                .sorted(Comparator.comparing((Account account) -> account.getFirstName())
                .thenComparing(Comparator.comparing(Account::getLastName)))
                        .toList();
    }
